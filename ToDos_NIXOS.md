 1. ✅ Auto load solaar config > Should be fixed with `exec-once solaar -w hide` in hyprland.conf
 2. 🚫 Bind mouse gestures
 3. ✅ Clean key bindings, e.G. (STRG+# in vscode) > Kinda obsolete
...
11. 🚫 Paste Emojis to Chrome without pressing enter > Situation is better now, can paste it via strg+v
...
16. ✅☑️F5 for Ducky Keyboard > Obsolete with Keychron Keyboard
17. ✅ Use hyprshot instead of ???
18. ✅ Freeze monitor when making a screenshot
19. 🚫 Find a good replacement for Postman
20. 🚫 Chrome crashes when pasting text from vscode
